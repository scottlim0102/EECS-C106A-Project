...
function thetas = theta_dictionary(rotmat)
    ...
    thetas('right_forearm_joint') = rotm2eul(rotmat{1}(1:3, 1:3)); 
    thetas('right_hand_joint') = rotm2eul(rotmat{2}(1:3, 1:3)); 
    thetas('left_arm_joint') = rotm2eul(rotmat{3}(1:3, 1:3)); 
    thetas('left_forearm_joint') = rotm2eul(rotmat{4}(1:3, 1:3)); 
    thetas('left_hand_joint') = rotm2eul(rotmat{5}(1:3, 1:3)); 
    thetas('right_upLeg_joint') = rotm2eul(rotmat{6}(1:3, 1:3)); 
